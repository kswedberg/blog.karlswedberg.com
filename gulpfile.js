...
// Require tasks
require('./gulp/tasks/build/index.js');
require('./gulp/tasks/clean/index.js');
require('./gulp/tasks/serve/index.js');
require('./gulp/tasks/lint/index.js');
require('./gulp/tasks/deploy/index.js');
